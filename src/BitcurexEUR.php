...
/**
 * Represents the Bitcurex EUR exchange wallet.
 * The old eur.bitcurex.com service; the new site has an unsafe accounts API, thus disabled.
 */
class BitcurexEUR extends AbstractWallet implements DisabledAccount {
